...
# Назначение тегов
docker tag 29_backend_t1 10.4.56.80:5000/29_backend_t1:$TAG || handle_error


# Публикация образов на Docker Hub
docker push 10.4.56.80:5000/29_backend_t1:$TAG || handle_error
...
case "$choice" in
  y|Y )
    docker tag 29_backend_t1 10.4.56.80:5000/29_backend_t1:latest || handle_error
    docker push 10.4.56.80:5000/29_backend_t1:latest || handle_error
